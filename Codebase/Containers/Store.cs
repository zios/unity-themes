namespace Zios
{
    ...
    public class Store<Type>
    {
        ...
        public Type Get()
        {
            return Utility.GetPlayerPref<Type>(this.name, this.defaultValue);
        }

        public void Set(Type value)
        {
            Utility.SetPlayerPref<Type>(this.name, value);
        }
        ...
        public static implicit operator Type(Store<Type> current)
        {
            return current.Get();
        }
    }
