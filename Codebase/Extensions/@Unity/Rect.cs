...
namespace Zios
{
    public static class RectExtension
    {
        ...
        public static Rect AddY(this Rect current, float value)
        {
            return current.Add(0, value);
        }
        ...
        public static Rect AddHeight(this Rect current, float value)
        {
            return current.Add(0, 0, 0, value);
        }
