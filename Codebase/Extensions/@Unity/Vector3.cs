...
namespace Zios
{
    public static class Vector3Extension
    {
        ...
        public static byte[] ToBytes(this Vector3 current)
        {
            return current.ToBytes(false);
        }
        ...
        public static Color ToColor(this Vector3 current)
        {
            return new Color(current.x, current.y, current.z);
        }

        public static string Serialize(this Vector3 current)
        {
            return current.ToString();
        }

        public static Vector3 Deserialize(this Vector3 current, string value)
        {
