...
namespace Zios
{
    public static class Vector4Extension
    {
        ...
        public static byte[] ToBytes(this Vector4 current)
        {
        ...
        public static Color ToColor(this Vector4 current)
        {
            return new Color(current.x, current.y, current.z, current.w);
        }

        public static string Serialize(this Vector4 current)
        {
            return current.ToString();
        }

        public static Vector4 Deserialize(this Vector4 current, string value)
        {
