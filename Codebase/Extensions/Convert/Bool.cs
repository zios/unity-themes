...
namespace Zios.Extensions.Convert{
	public static class ConvertBool{
		...
		public static string Serialize(this bool current,bool ignoreDefault=false,bool defaultValue=false){
			return ignoreDefault && current == defaultValue ? "" : current.ToInt().ToString();
		}
