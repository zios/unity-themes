...
namespace Zios
{
    public static class DecimalExtension
    {
        ...
        public static decimal Mean(this IEnumerable<decimal> current)
        {
        ...
        public static decimal Min(this decimal current, decimal value)
        {
            return Math.Min(current, value);
        }

        public static decimal Max(this decimal current, decimal value)
        {
