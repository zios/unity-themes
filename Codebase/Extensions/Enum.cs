...
namespace Zios
{
    public static class EnumExtension
    {
        ...
        public static bool Contains(this Enum current, params string[] values)
        {
            return current.Has(values);
        }
        ...
        public static bool Has(this Enum current, params string[] values)
        {
            return current.HasAny(values);
        }

        public static bool HasAny(this Enum current, params string[] values)
        {
            return current.MatchesAny(values);
        }

        public static bool HasAll(this Enum current, params string[] values)
        {
            return current.MatchesAll(values);
        }
        ...
        {
            return current.ToName().Split(" ").ContainsAny(values);
        }

        public static bool MatchesAll(this Enum current, params string[] values)
        {
            return current.ToName().Split(" ").ContainsAll(values);
        }
    }
}