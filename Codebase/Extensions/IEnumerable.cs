...
namespace Zios
{
    public static class IEnumerableExtension
    {
        ...
        public static int[] ToInt(this IEnumerable<string> current)
        {
            return current.Select(x => x.ToInt()).ToArray();
        }

        public static bool[] ToBool(this IEnumerable<string> current)
        {
            return current.Select(x => x.ToBool()).ToArray();
        }

        public static float[] ToFloat(this IEnumerable<string> current)
        {
            return current.Select(x => x.ToFloat()).ToArray();
        }

        public static UnityEngine.Color[] ToColor(this IEnumerable<string> current)
        {
            return current.Select(x => x.ToColor()).ToArray();
        }
    }
}