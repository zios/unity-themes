...
namespace Zios
{
    ...
    public static partial class ObjectExtension
    {
        ...
        public static T GetVariable<T>(this object current, string name, BindingFlags flags)
        {
            return current.GetVariable<T>(name, -1, flags);
        }
        ...
        public static object InstanceVariable(this object current, string name, bool force)
        {
            return current.InstanceVariable(name, -1, allFlags, force);
        }

        public static object InstanceVariable(this object current, string name, BindingFlags flags, bool force = false)
        {
            return current.InstanceVariable(name, -1, flags, force);
        }
