...
namespace Zios
{
    public static class StringExtension
    {
        ...
        {
            return (byte)current[0];
        }

        public static byte[] ToStringBytes(this string current)
        {
            return Encoding.ASCII.GetBytes(current);
        }

        public static string Serialize(this string current)
        {
            return current;
        }

        public static string Deserialize(this string current, string value)
        {
            return value;
        }
        ...
        public static GUIContent ToContent(this string current)
        {
            return new GUIContent(current);
        }
