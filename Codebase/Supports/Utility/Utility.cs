...
namespace Zios
{
    ...
    public static partial class Utility
    {
        ...
        public static void LogWarning(object key, string text, UnityObject target = null, int limit = -1)
        {
            Utility.Log(key, text, target, LogType.Warning, limit);
        }

        public static void LogError(object key, string text, UnityObject target = null, int limit = -1)
        {
            Utility.Log(key, text, target, LogType.Error, limit);
        }

        public static void LogWarning(string text, UnityObject target = null, int limit = -1)
        {
            Utility.Log(text, text, target, LogType.Warning, limit);
        }

        public static void LogError(string text, UnityObject target = null, int limit = -1)
        {
            Utility.Log(text, text, target, LogType.Error, limit);
        }
