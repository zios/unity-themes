...
public class AudioManager : MonoBehaviour{
	...
	public void Start(){
		Global.Console.AddCvarMethod("soundVolume",this,"soundVolume","Sound Volume",this.help[0],this.SetSoundVolume);
		Global.Console.AddCvarMethod("musicVolume",this,"musicVolume","Music Volume",this.help[1],this.SetMusicVolume);
		Global.Console.AddKeyword("mute",this.ToggleMute);
	...
	public void ToggleMute(string[] values,bool help){
		if(help){
			Global.Console.AddLog(this.help[2]);
			return;
		}
		foreach(AudioSource sound in FindObjectsOfType(typeof(AudioSource))){
