...
namespace Zios.Event
{
    ...
    public class EventDetector : MonoBehaviour
    {
        ...
        {
            Events.Call("On Fixed Update");
        }

        public virtual void LateUpdate()
        {
            Events.Call("On Late Update");
        }

        public virtual void OnPlayerConnected()
        {
            Events.Call("On Player Connected");
        }

        public virtual void OnPlayerDisconnected()
        {
            Events.Call("On Player Disconnected");
        }
        ...
        {
            Events.Call("On Application Quit");
        }

        public virtual void OnApplicationFocus()
        {
            Events.Call("On Application Focus");
        }

        public virtual void OnApplicationPause()
        {
            Events.Call("On Application Pause");
        }

        public virtual void OnDisconnectedFromServer()
        {
            Events.Call("On Disconnected From Server");
        }
        ...
        {
            Events.Call("On Enable");
        }

        public virtual void OnDisable()
        {
            Events.Call("On Disable");
        }
