...
namespace Zios.Interface
{
    ...
    public class EditorAction
    {
        ...
        public static implicit operator EditorAction(Action current)
        {
            return new EditorAction(current);
        }

        public static implicit operator EditorAction(Delegate current)
        {
            return new EditorAction((Action)current);
        }
    ...
    public class UnityLabel
    {
        ...
        public UnityLabel(string value)
        {
            this.value = new GUIContent(value);
        }

        public UnityLabel(GUIContent value)
        {
            this.value = value;
        }
        ...
        public static implicit operator UnityLabel(GUIContent current)
        {
            return new UnityLabel(current);
        }

        public static implicit operator UnityLabel(string current)
        {
            return new UnityLabel(current);
        }
    }
