...
namespace Zios{
	...
	public class Networker : MonoBehaviour{
		...
		public void Start(){
			...
			Console.AddShortcut(new string[]{"disconnect","leave"},"networkDisconnect");
			Console.AddShortcut(new string[]{"connect","join"},"networkConnect");
			Console.AddShortcut(new string[]{"chat","msg","query"},"networkChat");
			Console.AddShortcut(new string[]{"hostSimulated","startServerSimulated"},"networkHostSimulated");
			Console.AddShortcut(new string[]{"host","startServer"},"networkHost");
			Console.AddShortcut(new string[]{"listen"},"networkListen");
			Console.AddShortcut(new string[]{"showClients","clients"},"networkShowClients");
			Console.AddShortcut(new string[]{"showEvents","events"},"networkShowEvents");
			Console.AddShortcut(new string[]{"showHistory","history"},"networkShowHistory");
			Console.AddShortcut(new string[]{"clientName","name"},"networkClientName");
