...
#define TRANSFER_SHADOW(a) a._ShadowCoord = mul( unity_World2Shadow[0], mul( _Object2World, input.vertex ) );
...
#define TRANSFER_SHADOW(a) a._ShadowCoord = ComputeScreenPos(output.pos);
...
#define TRANSFER_SHADOW(a) a._ShadowCoord = mul(_Object2World, input.vertex).xyz - _LightPositionRange.xyz;
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, mul(_Object2World, input.vertex)).xyz; TRANSFER_SHADOW(a)
...
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, mul(_Object2World, input.vertex)); TRANSFER_SHADOW(a)
...
uniform sampler2D _LightTexture0;
uniform float4x4 _LightMatrix0;
#define TRANSFER_VERTEX_TO_FRAGMENT(a) a._LightCoord = mul(_LightMatrix0, mul(_Object2World, input.vertex)).xy; TRANSFER_SHADOW(a)
